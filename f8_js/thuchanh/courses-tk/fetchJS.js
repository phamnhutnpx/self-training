var urlData = 'http://localhost:3000/courses';
...
function handleViewData(datas) {
    ...
    var html = datas.map((data) => htmlList(data.id, data.name, data.description))
...
function fnEdit(id) {
    ...
    var description = document.getElementById(id).querySelector('p').innerText;
